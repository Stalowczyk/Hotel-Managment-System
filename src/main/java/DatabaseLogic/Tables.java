...
public class Tables {
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            st.executeUpdate("CREATE TABLE IF NOT EXISTS users(name varchar(200),password varchar(50),email varchar(200),address varchar(200),securityQuestion varchar(500),answer varchar(200),status varchar(20))");
